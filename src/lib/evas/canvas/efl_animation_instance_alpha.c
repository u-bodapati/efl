...
EOLIAN static void
_efl_animation_instance_alpha_alpha_set(Eo *eo_obj, Evas_Object_Animation_Instance_Alpha_Data *pd, double from_alpha, double to_alpha)
{
...
EOLIAN static void
_efl_animation_instance_alpha_alpha_get(Eo *eo_obj EINA_UNUSED, Evas_Object_Animation_Instance_Alpha_Data *pd, double *from_alpha, double *to_alpha)
{
   EFL_ANIMATION_INSTANCE_ALPHA_CHECK_OR_RETURN(eo_obj);
...
{
   EFL_ANIMATION_INSTANCE_ALPHA_DATA_GET(event->object, pd);
   ...
   Evas_Object *target = efl_animation_instance_target_get(event->object);
   evas_object_color_set(target, color, color, color, color);
}

EOLIAN static Efl_Object *
_efl_animation_instance_alpha_efl_object_constructor(Eo *eo_obj, Evas_Object_Animation_Instance_Alpha_Data *pd)
{
...
EOLIAN static void
_efl_animation_instance_alpha_efl_object_destructor(Eo *eo_obj, Evas_Object_Animation_Instance_Alpha_Data *pd EINA_UNUSED)
{
