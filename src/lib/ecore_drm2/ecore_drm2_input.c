...
static void
_seat_caps_update(Ecore_Drm2_Seat *seat)
{
   Ecore_Drm2_Event_Seat_Caps *ev;

   ev = calloc(1, sizeof(Ecore_Drm2_Event_Seat_Caps));
   if (!ev) return;
   ...
   ecore_event_add(ECORE_DRM2_EVENT_SEAT_CAPS, ev, NULL, NULL);
}
