...
static Efl_VG *
_apply_gradient_property(Svg_Style_Gradient *g, Efl_VG *vg, Evg_Data *vg_data)
{
   ...
   Eina_Rectangle r = { 0, 0, 1, 1 };
   Eina_Rectangle grad_geom = { 0, 0, 0, 0 };
   int radius;
...
// vg tree creation
static void
_apply_vg_property(Svg_Node *node, Efl_VG *vg, Evg_Data *vg_data)
{
...
static Efl_VG *
vg_common_create_vg_node_helper(Svg_Node *node, Efl_VG *parent, Evg_Data *vg_data)
{
   Efl_VG *vg = NULL;
   Svg_Node *child;
   Eina_List *l;
...
vg_common_create_vg_node(Svg_Node *node)
{
   ...
   vg_data = calloc(1, sizeof(Evg_Data));
...
Svg_Node *
vg_common_create_svg_node(Evg_Data *node)
{
   Svg_Node *doc;
