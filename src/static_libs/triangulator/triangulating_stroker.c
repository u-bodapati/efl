...
#include "triangulating_stroker.h"
#include <math.h>

#define PI 3.1415
#define CURVE_FLATNESS PI / 8

Triangulating_Stroker *
triangulating_stroker_new(void)
{
   Triangulating_Stroker *stroker = calloc(1, sizeof(Triangulating_Stroker));
...
void
triangulating_stroker_free(Triangulating_Stroker *stroker)
{
...
static void
add_line_segment(Triangulating_Stroker *stroker, float x, float y, float vx, float vy)
{
   float *ptr;
...
static void
add_arc_points(Triangulating_Stroker *stroker, float cx, float cy, float from_x, float from_y, float to_x, float to_y)
{
...
static void
move_to(Triangulating_Stroker *stroker, const double *pts)
{
...
static void
line_to(Triangulating_Stroker *stroker, const double *pts)
{
...
static void
cubic_to(Triangulating_Stroker *stroker, const double *pts)
{
   Eina_Bezier b;
...
static void
add_join(Triangulating_Stroker *stroker, float x , float y)
{
...
static void
end_cap(Triangulating_Stroker *stroker)
{
   float *ptr, *ptr1;
...
static void
_end_cap_or_join_closed(Triangulating_Stroker *stroker,
                        const double *start,
...
void
triangulating_stroker_process(Triangulating_Stroker *stroker,
