#include "simple_triangulator.h"

Simple_Triangulator *
simple_triangulator_new(void)
{
   Simple_Triangulator *st = calloc(1, sizeof(Simple_Triangulator));
...
void
simple_triangulator_free(Simple_Triangulator *st)
{
...
static void
_add_line(Simple_Triangulator *st, const float x, const float y)
{
   float *ptr;
...
void
simple_triangulator_process(Simple_Triangulator *st, const Efl_Gfx_Path_Command *cmds, const double *pts, Eina_Bool convex)
{
